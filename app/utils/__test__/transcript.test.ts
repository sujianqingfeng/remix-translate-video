	...
	it('processSentenceSegmentation', async () => {
		...
		expect(texts).toMatchInlineSnapshot(`
			[
			  ...
			  " In the recent study modeling a worst-case scenario in which Chinese tariffs on U.S.",
			  " goods rise by as much as 60 percent and retaliatory tariffs from other countries increase by 10 percent,",
			  " economists predicted significant export losses for the U.S.",
			  " agricultural sector,",
			  ...
			  " It trickles down through the U.S.",
			  " economy, farm equipment manufacturers,",
			  " seed companies,",
			  " chemical companies,",
