	...
	it('processSentenceSegmentation', async () => {
		...
		expect(texts).toMatchInlineSnapshot(`
			[
			  ...
			  "Well, suspended 625 meters above the Huajian Grand Canyon in China, a road like this is actually being built.",
			  "And it's a massive bridge.",
			  "One that crosses mountains, that breaks records, and that very few people actually know anything about.",
			  "In today's video,",
			  ...
			  "Before we get into it, we'd just like to take a second to thank Eric Sikowski from highestbridges .com.",
			  ...
			  "It's an encyclopedia of everything bridge -related, so definitely check it out if you're interested.",
			  ...
			  "Historically, outsiders rarely traveled there, and the local people rarely left, making Guizhou mysterious and unknown.",
			  "In fact, in ancient Chinese, "Guizhou" actually translates to "the land of the demons."",
			  "Despite being about the same size as Missouri or Uruguay, Guizhou is almost completely covered by mountains and hills.",
			  "And we're not talking about gentle rolling hills, either.",
			  "Guizhou is a land of extremes, from stunning waterfalls to enormous canyons to insane rock formations.",
			  ...
			  "Karsts are easily eroded by water, and over time, the rock dissolves to create these insane landscapes.",
			  ...
			  "Anyway, the point that we're trying to make here is that Guizhou is inhospitable, let's say.",
			  ...
			  "Rain can set in for literal weeks at a time, which, combined with the terrain, makes agriculture very difficult here.",
			  ...
			  "When they arrived, they discovered that there was no accommodation for tourists, and that only a few people spoke Chinese.",
			  "Local tradition meant the visitors were welcomed, and they were soon invited into the home of the village leader.",
			  ...
			  "Who knows, there may be some poetic license there, but the point is simple.",
			  "Guizhou is remote, wild, and notoriously difficult to build in.",
			  "But since 1989, the Chinese government has been on a road -building spree.",
			  ...
			  "Now, they're working on the next stage of development, which will link many of the smaller cities across the nation.",
			  ...
			  "And in true Chinese fashion, nothing is getting in the way of development, not even the impenetrable mountains of Guizhou.",
			  ...
			  "Italy, who's number two on the list as a whole country, only has 60 in total.",
			  "In fact, three of the highest bridges in the world, including those under construction, are in Guizhou.",
			  "And what's even crazier is that all three of them cross the same river, the Beipan.",
			  "And that's not to mention all its other bridges.",
			  "No river in the world has as many record -breaking bridges as the Beipan, and it's easy to see why.",
			  ...
			  "Not only that, but thanks to all its rivers, Guizhou is also a prime location for hydropower facilities.",
			  "As a result,",
			  ...
			  "But that's not all.",
			  "The Huajiang Bridge isn't just a transport link, it's also a destination.",
			  ...
			  "And that's not all.",
			  "The elevator will also drop visitors off underneath the road deck, inside the support trusses themselves.",
			  "As cars pass overhead, people can explore the walkway that stretches 800 meters out to the middle of the bridge.",
			  ...
			  "With all that in mind, you're probably wondering how much this is all gonna cost.",
			  "Well, we're not gonna lie, finding a price tag for this was pretty darn difficult.",
			  ...
			  "So the question we all want answered, would you do the world's highest bungee jump off of this bridge?",
